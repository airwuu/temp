...
USE variables so colors can change easily
**Base Colors**:
```
...
@keyframes pulse-glow {
  0%, 100% { box-shadow: 0 0 20px rgba(58, 78, 255, 0.5); }
  50%      { box-shadow: 0 0 40px rgba(58, 58, 255, 0.8), 0 0 60px rgba(0, 245, 212, 0.5); }
}
